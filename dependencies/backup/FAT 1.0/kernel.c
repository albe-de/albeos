...
void kernel_main(uint32_t mb_info_ptr) {
    ...
    fb_draw_string(30, 300, create_file("TEST1.TXT", a_fat_start, a_data_start, a_bpb, a_root_cluster), 0x0000FF00, 2, &font_console);
    fb_draw_string(30, 320, create_file("TEST2.TXT", a_fat_start, a_data_start, a_bpb, a_root_cluster), 0x0000FF00, 2, &font_console);
    fb_draw_string(30, 340, create_file("TEST3.TXT", a_fat_start, a_data_start, a_bpb, a_root_cluster), 0x0000FF00, 2, &font_console);

    fb_draw_string(30, 360, write_file("TEST1.TXT", "NEW: This is the data of test1", a_fat_start, a_data_start, a_bpb, a_root_cluster), 0x0000FF00, 2, &font_console);
    fb_draw_string(30, 380, read_file ("TEST1.TXT", a_fat_start, a_data_start, a_bpb, a_root_cluster), 0x00FFFFFF, 2, &font_console);

    fb_draw_string(30, 400, write_file("TEST2.TXT", "NEW: This is the data of test2", a_fat_start, a_data_start, a_bpb, a_root_cluster), 0x0000FF00, 2, &font_console);
    fb_draw_string(30, 420, delete_file("TEST2.TXT", a_fat_start, a_data_start, a_bpb, a_root_cluster), 0x00FF0000, 2, &font_console);
    fb_draw_string(30, 440, read_file ("TEST2.TXT", a_fat_start, a_data_start, a_bpb, a_root_cluster), 0x00FFFFFF, 2, &font_console);
